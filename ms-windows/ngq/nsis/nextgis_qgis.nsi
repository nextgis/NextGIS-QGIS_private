...
;QGIS_DEFAULT_OPTIONS_1_PATH
;QGIS_DEFAULT_OPTIONS_1_NAME
;QGIS_DEFAULT_OPTIONS_2_PATH
;QGIS_DEFAULT_OPTIONS_2_NAME
;QGIS_DEFAULT_OPTIONS_COUNT = 2
!ifndef QGIS_DEFAULT_OPTIONS_1_PATH
    !define QGIS_DEFAULT_OPTIONS_1_PATH "..\ngq_default_options\QGIS"
    !define QGIS_DEFAULT_OPTIONS_COUNT 1
!endif
